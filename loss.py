...
class BipartiteEdgePred:
    def __init__(self, loss_fn='xent', neg_sample_weights=1.0, is_normalized_input=True, reduction = 'mean'):
        """
        Ref: https://github.com/vinhsuhi/SubGraphFreq/blob/master/models/graphsage/prediction.py
    ...
    def neg_cost(self, inputs1, neg_samples, hard_neg_samples=None):
        ...
        return neg_aff
    def __call__(self, inputs1, inputs2, embeddings, degrees):
